...
{
    protected $fillable = ['type', 'title_ar', 'title_en', 'sort'];
    ...
    public function categories() {
        return $this->belongsToMany('App\Category', 'home_elements', 'home_id','element_id');
    }
    ...
    public function brands() {
        return $this->belongsToMany('App\Brand', 'home_elements', 'home_id','element_id');
    }
