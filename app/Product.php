...
class Product extends Model
{
    ...
    public function mOptionsValuesEn() {
        return $this->belongsToMany('App\MultiOptionValue', 'product_multi_options', 'product_id', 'multi_option_value_id')->select('value_en as value', 'multi_option_values.id as option_value_id', 'product_multi_options.remaining_quantity')->where('product_multi_options.remaining_quantity', '>', 0);
    }
