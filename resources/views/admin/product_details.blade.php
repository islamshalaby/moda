                ...
                <table class="table table-bordered mb-4">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                @if(App::isLocale('en'))
                                {{ isset($data['product']->values[$k]) ? $data['product']->values[$k]['value_en'] : '' }}
                                @else
                                {{ isset($data['product']->values[$k]) ? $data['product']->values[$k]['value_ar'] : '' }}
                                @endif
                            </td>
                        </tr>
                        @endfor          
                ...
                <div class="row">
                    @if (count($data['product']['images']) > 0)
                        ...
                        <div style="position : relative" class="col-md-2 product_image">
                            <img width="100%" src="https://res.cloudinary.com/dk1fceelj/image/upload/w_100,q_100/v1581928924/{{ $image->image }}"  />
                        </div>
                        @endforeach
                    @endif
                </div>
