                    ...
                    success : function (data) {
                        ...
                        data.forEach(function (option) {
                            ...
                            <div class="col-sm-1 text-option">
                                <div class="n-chk">
                                    <label class="new-control new-checkbox new-checkbox-text checkbox-primary">
                                    <input data-multi="multi${option.id}" name="multi_option_id" checked type="radio" value="${option.id}" class="new-control-input all-permisssions">
                                    <span class="new-control-indicator"></span><span class="new-chk-content">${optionName}</span>
                                    </label>
                                </div>  
                            </div>
        ...
        if ($("#typeSelect").val() == 1) {
            ...
            @else
                ...
                $("#multi_options_radio .row").on('change', 'select.multi_tags', function() {
                    ...
                    var mOptionsValuesIds = {{ $data['encoded_multi_options'] }}
                    for (var i = 0; i < $(this).val().length; i ++) {
                        console.log({{ $data['encoded_multi_options'] }})
                        
                        if (mOptionsValuesIds.includes(Number($(this).val()[i])) == false) {
                            console.log("dd")
                            var priceAfterDiscountInput = ""
                            if ($("#discount").is(":checked")) {
                                priceAfterDiscountInput = `<td><input type="text" disabled class="form-control" > <input type="hidden" class="form-control" name="price_after_discount[]" ></td>`
            ...
            <div class="form-group mb-4">
                ...
                @if (count($data['product']->images) > 0)
                    ...
                    <div style="position : relative" class="col-md-2 product_image">
                        ...
                        <img style="width: 100%" src="https://res.cloudinary.com/dk1fceelj/image/upload/w_100,q_100/v1581928924/{{ $image->image }}"  />
                    </div>
                    @endforeach
                @endif
                </div>
            ...
            <div class="statbox widget box box-shadow">
                <div class="widget-content widget-content-area">
                    <div id="circle-basic" class="">
                        ...
                        <section>
                            <h4 class="text-center text-block">{{ __('messages.please_add_number') }}</h4>
                            ...
                            <div class="form-group mb-4">
                                <label for="">{{ __('messages.video_image') }}</label><br>
                                <div class="row">
                                    <div style="position : relative" class="col-md-2 product_image">
                                        <img style="width: 100%" src="https://res.cloudinary.com/dk1fceelj/image/upload/w_100,q_100/v1581928924/{{ $data['product']['video_image'] }}"  />
                                    </div>
                                </div>
                            </div>
                            <div class="custom-file-container" data-upload-id="mySecondImage">
                                <label>{{ __('messages.upload') }} ({{ __('messages.video_image') }}) * <a href="javascript:void(0)" class="custom-file-container__image-clear" title="Clear Image">x</a></label>
                                <label class="custom-file-container__custom-file" >
                                    <input type="file" required name="video_image" class="custom-file-container__custom-file__custom-file-input" accept="image/*">
                                    <input type="hidden" name="MAX_FILE_SIZE" value="10485760" />
                                    <span class="custom-file-container__custom-file__custom-file-control"></span>
                                </label>
                                <div class="custom-file-container__image-preview"></div>
