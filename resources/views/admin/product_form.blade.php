    ...
    <script>
        ...
        $("#properties-items .row").on('click', 'select', function() {
            ...
            $(".actions ul").find('li').eq(1).on("mouseover", "a.next1", function() {
                ...
                if (image.length > 0 && categorySelect > 0 && titleEnInput.length > 0 && titleArInput.length > 0 && descriptionEnText.length > 0 && descriptionArText.length > 0 && typeSelect > 0 && storeSelect > 0 && periodInput.length > 0) {
                    $(this).attr('href', '#next')
                    $(this).addClass('next2')
                }else {
                    $(this).attr('href', '#')
