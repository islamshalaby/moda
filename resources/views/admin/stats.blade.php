                                                ...
                                                <div class="table-responsive">
                                                    <table class="table">
                                                        <thead class="">
                                                            ...
                                                            <tr>
                                                                <th scope="col">{{ __('messages.main_orders_count') }}</th>
                                                                <th scope="col">{{ $data['main_orders'] }}</th>
                                                            </tr>
                                                            <tr>
                                                                <th scope="col">{{ __('messages.sub_orders_count') }}</th>
                                                                <th scope="col">{{ $data['sub_orders'] }}</th>
                                                            </tr>
                                                            <tr>
