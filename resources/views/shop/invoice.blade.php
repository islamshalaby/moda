                                    ...
                                    <div class="row inv--head-section">
                                        ...
                                        <div class="col-sm-6 col-12 align-self-center text-sm-right">
                                            <div class="company-info">
                                                <img src="https://res.cloudinary.com/dk1fceelj/image/upload/w_50,q_50/v1581928924/{{ Auth::user()->logo }}" class="navbar-logo" alt="logo">
                                            </div>
                                        </div>
                                                ...
                                                <table class="table">
                                                    <thead class="">
                                                        <tr>
                                                            ...
                                                            <th scope="col">{{ App::isLocale('en') ? $data['m_option']['title_en'] : $data['m_option']['title_ar'] }}</th>
                                                            <th class="text-right" scope="col">{{ __('messages.quantity') }}</th>
                                                            <th class="text-right" scope="col">{{ __('messages.additional_details') }}</th>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><img style="width: 100%" src="https://res.cloudinary.com/dk1fceelj/image/upload/w_50/v1581928924/{{ $item->product->mainImage->image }}"  /></td>
                                                            ...
                                                            <td class="text-right">{{ isset($item->size) ? $item->size->details : '' }}</td>
                                        ...
                                        <div class="col-12">
                                            <div class="table-responsive">
                                                <table class="table">
                                                    <thead class="">
                                                        <tr>
                                                            <th scope="col">{{ __('messages.length') }}</th>
                                                            <th scope="col">{{ __('messages.shoulder') }}</th>
                                                            <th scope="col">{{ __('messages.chest') }}</th>
                                                            <th scope="col">{{ __('messages.waist') }}</th>
                                                            <th class="text-right" scope="col">{{ __('messages.buttock') }}</th>
                                                            <th class="text-right" scope="col">{{ __('messages.sleeve') }}</th>
                                                            <th class="text-right" scope="col">{{ __('messages.additional_details') }}</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                        <tr>
                                                            <td>{{ $item->size->tall }}</td>
                                                            <td>{{ $item->size->shoulder_width }}</td>
                                                            <td>{{ $item->size->chest }}</td>
                                                            <td>
                                                                {{ $item->size->waist }}
                                                            </td>
                                                            <td class="text-right">{{ $item->size->buttocks }}</td>
                                                            <td class="text-right">{{ $item->size->sleeve }}</td>
                                                            <td class="text-right">{{ $item->size->details }}</td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>
